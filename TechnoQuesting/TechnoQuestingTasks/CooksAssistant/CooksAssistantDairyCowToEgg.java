...
public class CooksAssistantDairyCowToEgg extends Task {
    ...
    public static final Tile pathDairyCowToEgg[] = {new Tile(3171, 3317, 0), new Tile(3174, 3316, 0), new Tile(3177, 3313, 0), new Tile(3180, 3310, 0), new Tile(3183, 3308, 0), new Tile(3186, 3308, 0), new Tile(3189, 3305, 0), new Tile(3189, 3302, 0), new Tile(3188, 3299, 0), new Tile(3188, 3296, 0), new Tile(3188, 3293, 0), new Tile(3188, 3290, 0), new Tile(3188, 3287, 0), new Tile(3191, 3284, 0), new Tile(3194, 3281, 0), new Tile(3197, 3280, 0), new Tile(3200, 3279, 0), new Tile(3203, 3279, 0), new Tile(3206, 3279, 0), new Tile(3209, 3280, 0), new Tile(3212, 3280, 0), new Tile(3215, 3277, 0), new Tile(3218, 3275, 0), new Tile(3221, 3272, 0), new Tile(3222, 3269, 0), new Tile(3225, 3267, 0), new Tile(3227, 3264, 0), new Tile(3230, 3262, 0), new Tile(3233, 3262, 0), new Tile(3236, 3262, 0), new Tile(3239, 3262, 0), new Tile(3241, 3265, 0), new Tile(3240, 3268, 0), new Tile(3240, 3271, 0), new Tile(3240, 3274, 0), new Tile(3240, 3277, 0), new Tile(3241, 3280, 0), new Tile(3240, 3283, 0), new Tile(3240, 3286, 0), new Tile(3240, 3289, 0), new Tile(3239, 3292, 0), new Tile(3238, 3295, 0), new Tile(3235, 3295, 0), new Tile(3232, 3297, 0), new Tile(3229, 3299, 0)};
